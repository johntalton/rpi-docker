...
(
	set -x
	/usr/sbin/debootstrap --no-check-gpg --arch=armhf --verbose --variant='minbase' --include='iproute2,iputils-ping' buster "$rootfsDir" http://archive.raspbian.org/raspbian/
)
